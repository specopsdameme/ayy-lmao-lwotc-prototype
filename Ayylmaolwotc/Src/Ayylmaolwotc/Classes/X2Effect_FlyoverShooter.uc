...
class X2Effect_FlyoverShooter extends X2Effect_Persistent;
...
simulated function PatchSequentialShots_PostBuildVisualization(XComGameState VisualizeGameState)
{
    ...
    VisMgr.GetNodesOfType(VisMgr.BuildVisTree, class'X2Action_AbilityPerkStart', arrActions);
    ...
    if (arrActions.Length > 0 && UnitState.ObjectID==SourceUnit.ObjectID)
    {
